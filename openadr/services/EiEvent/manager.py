...
def Response(request_h):
    ...
    if incoming_msg == oadrCfg.OADR_EIEVENT.oadrDistributeEvent:
        events_in    = read_oadrDistributeEvent_msg(request_h)
        events_out   = process_oadrDistributeEvent_msg(events_in)
        outgoing_msg = compose_oadrDistributeEvent_msg(events_out)
    ...
    # outgoing : oadrResponse     : vtn -> ven 
        ...
        outgoing_msg     = compose_oadrResponse_msg()
        return outgoing_msg
    ...
    # outgoing : oadrDistributeEvent : vtn -> ven 
        ...
        outgoing_msg     = compose_oadrDistributeEvent(events_created)
        return outgoing_msg
