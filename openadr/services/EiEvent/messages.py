...
#
    ...
    etree.SubElement(e_eiResponse, en.responseCode).text = '123'
...
#
    ...
    if events:
        ...
        for event in events:
            ...
            etree.SubElement(e_eventResponse, en.responseCode).text = '245'
...
#
    ...
    etree.SubElement(e_eiResponse, en.responseCode).text = '672'
    etree.SubElement(e_eiResponse, en.responseDescription).text = 'ei:responseDescription'
    etree.SubElement(e_eiResponse, en.requestID).text = 'pyld:requestID'
